       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"o"
                  then yyQ94(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyQ45(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ45(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp < #"a"
              then if inp = #"_"
                  then yyQ45(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyAction49(strm, yyNO_MATCH)
       ...
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"e"
                  then yyQ101(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
                  else yyQ45(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ45(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
              else yyAction49(strm, yyNO_MATCH)
        ...
        | SOME(inp, strm') =>
            if inp = #","
              ...
              then if inp = #")"
                  ...
                  else yyQ111(strm', yyMATCH(strm, yyAction50, yyNO_MATCH))
            else if inp = #"/"
       ...
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ119(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
